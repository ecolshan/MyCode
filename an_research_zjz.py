...
os.system('date')
import re
fh = open('/home/wuq/projects/convergence/an_research_zjz.txt','w')
count = {}
for family in os.listdir('/home/wuq/projects/convergence/workShop_14254_zjz/'):
    for rst in os.listdir('/home/wuq/projects/convergence/workShop_14254_zjz/'+family+'/rst/'):
        an = ''
        if rst[-4:] == '.txt' and rst[:3] == 'rst':
          # print family,rst,os.path.getsize('/home/wuq/projects/convergence/workShop_14254_zjz/'+family+'/rst/'+rst)
            if os.path.getsize('/home/wuq/projects/convergence/workShop_14254_zjz/'+family+'/rst/'+rst) == 0: continue
            for line in open('/home/wuq/projects/convergence/workShop_14254_zjz/'+family+'/rst/'+rst):
                an += line
            #print family
...
#           print family,'\t',faa_id,'\t',an_giant,an_red,'\t',giant,red,pbe,mpu,caf,tig,hum,mus;raw_input() 
            if giant == red and giant != an_giant and red != an_red :
               #print family,'\t',faa_id,'\t',an_giant,an_red,'\t',giant,red,pbe,mpu,caf,tig,hum,mus;raw_input() 
